...
describe('Window', () => {
  ...
  describe('#constructor', () => {
    it('should initialize Window', () => {
      ...
      expect(win.timeSlices.length).toBe(5);
    ...
    it('should throw error if updated is invalid', () => {
  ...
  describe('#slicesBetween', () => {
    const win = Window.fromConfig({unit: 'minute', width: 2, size: 5});
    it('should return number of slices between timestamps', () => {
  ...
  describe('#update()', () => {
    it('should throw error if invalid parameter', () => {
      const win = new Window({timeSlices: [0, 0, 0, 0, 0], unit: 'minute', width: 2, updated: '2025-01-01T00:00:00Z'});
      let fn = () => win.update('a');
